...
final crmMenuProvider = FutureProvider<List<CrmMenuSection>>((ref) async {
...
List<CrmMenuNode> _filterNodesByPermission(
  ...
  for (final n in nodes) {
    ...
    if (children != null && children.isNotEmpty) {
      final filteredChildren = _filterNodesByPermission(
        children,
        allowedRefsLower,
      );
...
String _mapRefToRoute(String ref) {
  ...
  return switch (r) {
    ...
    'satinalim_teklifler' => '/purchase/orders',
    'satinalim_talepler' => '/purchase/orders',
    'satinalim_siparisler' => '/purchase/orders',
    'insert_satinalim_siparis' => '/purchase/orders',
    'insert_satinalim_siparis_urun' => '/purchase/orders',
    'olustur_satinalim_siparis' => '/purchase/orders',
    'olustur_tedarikci' => '/purchase/orders',
    'list_satinalim_siparis' => '/purchase/orders',
    'find_satinalim_siparis' => '/purchase/orders',
    _ => '/legacy/$ref',
  };
}
...
IconData _guessIcon(String text) {
  ...
  if (t.contains('fatura') || t.contains('irsaliye')) {
    return Icons.request_quote_outlined;
  }
  if (t.contains('depo')) return Icons.warehouse_outlined;
  if (t.contains('sayım') || t.contains('sayim')) {
    return Icons.fact_check_outlined;
  }
  if (t.contains('reçete') || t.contains('recete')) {
  ...
  if (t.contains('sipariş') || t.contains('siparis')) {
