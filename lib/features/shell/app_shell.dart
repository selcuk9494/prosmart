    ...
    final sections = [
      ...
      _MenuSection(
        ...
        items: const [
          _MenuItem(
            title: 'Genel Bakış',
            subtitle: 'Nakit akışı ve özet',
            icon: Icons.trending_up_outlined,
            route: '/accounting',
            permissionRef: 'ps_accounting',
          ),
          _MenuItem(
            title: 'Satış Faturaları',
            subtitle: 'Satış ve tahsilat',
            icon: Icons.receipt_long_outlined,
            route: '/legacy/accounting_sales_invoices',
            permissionRef: 'ps_accounting_sales',
          ),
          _MenuItem(
          ...
          _MenuItem(
            title: 'Giderler',
            subtitle: 'Masraf faturaları',
            icon: Icons.payments_outlined,
            route: '/legacy/accounting_expenses',
            permissionRef: 'ps_accounting_expenses',
          ),
          _MenuItem(
            title: 'Müşteri & Tedarikçi',
            subtitle: 'Cari kartlar',
          ...
          _MenuItem(
            title: 'Nakit Durumu',
            subtitle: 'Kasa ve banka özet',
            icon: Icons.account_balance_wallet_outlined,
            route: '/legacy/accounting_cash_status',
            permissionRef: 'ps_accounting_cash',
          ),
          _MenuItem(
            title: 'Kasalar',
          ...
          _MenuItem(
            ...
            route: '/legacy/accounting_banks',
            permissionRef: 'ps_accounting_banks',
          ),
          _MenuItem(
            title: 'Çekler',
            subtitle: 'Alınan/verilen çekler',
            icon: Icons.fact_check_outlined,
            route: '/legacy/accounting_cheques',
            permissionRef: 'ps_accounting_cheques',
          ),
          _MenuItem(
            title: 'Raporlar',
            subtitle: 'Satış, alış, KDV',
            icon: Icons.bar_chart_outlined,
            route: '/legacy/accounting_reports',
            permissionRef: 'ps_accounting_reports',
          ),
        ],
      ),
      _MenuSection(
